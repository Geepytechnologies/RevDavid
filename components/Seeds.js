  ...
  return (
    <div className=''>
      <div className=' w-[300px] h-[300px] border-2 border-[white]'>
       <Image src="/bgg2.jpg" alt="" layout='responsive' height="100%" width="100%" objectFit='cover'  />
      </div>
       <p className='text-[black]'>Seeds and Offerings</p>

      <Button onClick={()=>Router.push('/contact/seeds')}>Give</Button>
