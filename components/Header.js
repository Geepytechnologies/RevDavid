...
export default function Header() {
  return (
    <div>
        <Head>
        <title>Rev David Akanwa</title>
        <meta name="description" content="Rev David Akanwa" />
        ...
        <link href="https://fonts.googleapis.com/css2?family=Allura&family=Tangerine:wght@400;700&display=swap" rel="stylesheet"></link>
    </div>
  )
}
